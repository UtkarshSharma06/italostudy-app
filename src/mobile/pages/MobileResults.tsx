...
const MobileResults = () => {
    ...
    return (
        <div className="flex flex-col h-screen bg-background overflow-hidden">
                ...
                <div className="h-16 flex items-center justify-between w-full">
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[8px] font-black text-primary uppercase tracking-[0.2em] mt-1 opacity-60">Performance Report</span>
                        </div>
                    </div>
                </div>
            </header>
            ...
            {/* Content Area */}
            <main className="flex-1 overflow-y-auto safe-area-bottom relative bg-background">
                <Results hideLayout={true} />
            </main>
        </div>
    );
};
