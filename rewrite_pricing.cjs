...
// Convert the old content block to flex md:hidden
...
// Inject the desktop block right before the old block, regardless of \n or \r\n
...
console.log('Successfully updated PricingModal.tsx');
