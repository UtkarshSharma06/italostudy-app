...
const MobileDetailedAnalysis = () => {
    ...
    return (
        <div className="flex flex-col h-screen bg-background overflow-hidden">
            ...
            {/* Content Area */}
            <main className="flex-1 overflow-y-auto safe-area-bottom relative bg-[#f5f6fb]">
                <DetailedAnalysis hideLayout={true} />
            </main>
        </div>
    );
};

export default MobileDetailedAnalysis;
