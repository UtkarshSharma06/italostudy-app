...
export default function MobilePricing() {
    ...
    return (
        <MobileLayout>
            <div className="min-h-screen bg-[#Fdfdfd] dark:bg-slate-950 font-sans text-slate-900 dark:text-white selection:bg-indigo-100 selection:text-indigo-900 relative pb-20">
                <SEO
                ...
                <div className="fixed inset-0 pointer-events-none z-0">
                    <div className="absolute top-[0%] left-[-20%] w-[80%] h-[50%] bg-purple-100/40 dark:bg-purple-900/20 rounded-full blur-[120px]" />
                    <div className="absolute top-[30%] right-[-10%] w-[60%] h-[40%] bg-blue-100/40 dark:bg-blue-900/20 rounded-full blur-[120px]" />
                </div>
                ...
                <main className="relative z-10 pt-12 pb-8 px-4 sm:px-6">
                    <div className="container mx-auto max-w-6xl">
                        ...
                        {/* Pricing Cards */}
                        <div className="grid gap-6 items-stretch mb-8 mx-auto max-w-md">
                            {plans.map((plan) => (
                                <div
                                    key={plan.id}
                                    className={cn(
                                        ...
                                        plan.isPopular
                                            ...
                                            : "bg-white/70 dark:bg-slate-900/70 backdrop-blur-md shadow-md border-white/60 dark:border-slate-800"
                                    )}
                                >
                                    {plan.isPopular && (
                        ...
                        {/* FAQ Section - Compact */}
                        <div className="max-w-4xl mx-auto mt-8 bg-white/60 dark:bg-slate-900/60 backdrop-blur-md rounded-3xl p-6 border border-white/60 dark:border-slate-800 shadow-lg mb-8">
